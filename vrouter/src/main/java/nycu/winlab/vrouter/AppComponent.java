...
public class AppComponent {
    ...
    private IpAddress bgpSpeakerIpv4 = IpAddress.valueOf("192.168.70.10");
    private IpAddress bgpSpeakerIpv6 = IpAddress.valueOf("fd70::10");
    ...
    protected void activate() {
        ...
        installBgpIntent();
        FilteredConnectPoint peerA = new FilteredConnectPoint(ConnectPoint.deviceConnectPoint("of:0000011155014202/4"));
        FilteredConnectPoint peerB = new FilteredConnectPoint(ConnectPoint.deviceConnectPoint("of:0000011155014202/5"));
        installPeerIntent(peerA, IpPrefix.valueOf("192.168.70.11/32"), IpPrefix.valueOf("fd70::11/128"));
